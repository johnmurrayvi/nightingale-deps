...
String ASF::Tag::conductor() const
{
...
String ASF::Tag::recordLabel() const
{
...
void ASF::Tag::setLicense(const String &value)
{
  d->license = value;
}
...
void ASF::Tag::setLyrics(const String &value)
{
...
void ASF::Tag::setProducer(const String &value)
{
...
void ASF::Tag::setConductor(const String &value)
{
  setAttribute("WM/Conductor", value);
}

void ASF::Tag::setLyricist(const String &value)
{
  setAttribute("WM/Writer", value);
}

void ASF::Tag::setRecordLabel(const String &value)
{
...
void ASF::Tag::setDisc(uint value)
{
  setAttribute("WM/PartOfSet", String::number(value));
}

void ASF::Tag::setBpm(uint value)
{
